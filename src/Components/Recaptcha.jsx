...
// Working Final with Redirect to Payment Page
...
const Recaptcha = () => {
  ...
  const handleBoxClick = (index) => {
    if (!verificationSuccess) {
      ...
      // Check if the selected letter is already in the list
      if (!selectedLetters.includes(selectedLetter)) {
        setSelectedLetters((prevSelectedLetters) => [...prevSelectedLetters, selectedLetter]);
      }
    }
  ...
  return (
    ...
    <div className="container">
      ...
      <div id='recaptcha'>
        ...
        {verificationMessage && <p>{verificationMessage}</p>}
        {verificationSuccess ? (
          <p id='recaptcha'>Verification successful! User is human.</p>
        ) : (
          <p id='recaptcha'>Click boxes to form the correct sequence and verify.</p>
        )}
      </div>
